<footer>
                    ...
                    <ul class="list-unstyled"> 
                        <li>
                            <a class="navbar-brand" href="/">
                                <h3 class="d-none">BRZ expo</h3>
                                <img src="img/logo.png" alt="Logo">
                            </a>
                        </li>
                        <li>
                            <a href="tel:5521982242190">
                                <i class="fas fa-phone"></i>
                                <h3>Call us</h3>
                                <p>+55 21 982 242 190</p>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:contato@brzexpo.com.br">
                                <i class="fas fa-envelope"></i>
                                <h3>Email</h3>
                                <p>contato@brzexpo.com.br</p>
                            </a>
                        </li>
                        <li>
                            <a href="#">
        ...
        <div class="container-copyright">
            <div class="container">
                <div class="col-12 col-md-8 offset-md-2 text-center">
                    <p>© 2021 - BRZ Expo is a trademark of Vitrine Brasil Internacional Comercial Exportadora LTDA. – Rio de Janeiro / Brazil</p>
                </div>
            </div>
        </div>
    </footer>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 col-lg-7 offset-lg-1">
                            <h3>We are committed to our international customers to offer high quality products, which respect the best environmental, administrative and social practices.</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse dictum ipsum quis eros convallis consequat. Maecenas sed purus eu dolor fringilla malesuada in quis enim. Phasellus eu dictum augue. Aenean sit amet pretium est. </p>
    ...
    <div class="modal fade" id="vitao" tabindex="-1" aria-labelledby="vitao" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content container p-0">
                <div class="modal-header">
                    <a class="navbar-brand" href="/">
    ...
    <div class="modal fade" id="britivic" tabindex="-1" aria-labelledby="britivic" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content container p-0">
                <div class="modal-header">
                    <a class="navbar-brand" href="/">
    ...
    <div class="modal fade" id="contatoModalSucesso" tabindex="-1" aria-labelledby="contatoModalSucesso" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content container p-0">
                <div class="modal-header">
                    <a class="navbar-brand" href="/">
    ...
    <div class="credits mk-width-100">
      <div class="container">
        <div class="row">
          <div class="col">
            <p class="powered mk-powered">Mixed with <i class="icon heart"></i> by <a href="https://agenciamilkshake.com.br/" target="_blank" alt="Milkshake Branding &amp; Design" title="Milkshake Branding &amp; Design"><i class="icon milkshake"></i></a></p>
          </div>
        </div>  
      </div>
    </div>
