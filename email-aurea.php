...
//enviar
  ...
  $destino = $emailenviar;
  $assunto = "Contato pelo Site - Form Aurea";
      ...
      <div class='modal-content container p-0'>
          <div class='modal-header'>
              ...
              <div class='col-12 text-center'>
                  ...
                  <a class='btn btn-primary btn-brz' href='https://brzexpo.com.br/aurea-catalogo.pdf'>Download catalogue</a>
              </div>
          </div>
      </div>
  </div>
...
echo $mgm;
  ...
  echo "<h2>Ocorreu um erro, <a href='/'>clique aqui</a> e tente novamente</h2>" + "<p>" + $mgm + "</p>";
  }
?>